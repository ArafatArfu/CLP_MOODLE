...
@section('breadcrumb')
    <li class="breadcrumb-item text-muted">
        <a href="{{ route('school-infos.index') }}" class="text-muted text-hover-primary">School Info</a>
    </li>
    <li class="breadcrumb-item">
        <span class="bullet bg-gray-400 w-5px h-2px"></span>
    </li>
    <li class="breadcrumb-item text-muted">Add School Info</li>
@endsection
@section('content')
    <!--begin::Card-->
    <div class="card">
                ...
                <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_shchool_info_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <div class="checkbox-list">
                            <label class="radio">
                                <input type="radio" id="add-school-info-clc" value="clc" name="clc[]" checked>
                                <span></span>
                                CLC
                            </label>
                            <label class="radio" >
                                <input type="radio" id="add-school-info-clc-scr" value="scr" name="clc[]">
                                <span></span>
                                SCR
                            </label>
                        </div>
                    ...
                    <div class="fv-row mb-7">
                        <!--begin::Label-->
                        <label for="add-school-info-support-condition" class="fw-semibold fs-6 mb-2">Support Status</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        <select id="add-school-info-support-condition" class="form-select form-select-solid" name="support" data-control="select2" data-placeholder="Select an option" data-allow-clear="true">
                    ...
                    <div class="fv-row mb-7">
                        <!--begin::Label-->
                        <label for="add-school-info-history" class="fw-semibold fs-6 mb-2">History of the Center</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        <textarea id="add-school-info-history" type="textarea" name="history" class="form-control form-control-solid mb-3 mb-lg-0 textarea-ck" placeholder="Center history"></textarea>
                        <!--end::Input-->
                    </div>
                    <div class="fv-row mb-7">
                        <!--begin::Label-->
                        <label for="add-school-info-contact" class="fw-semibold fs-6 mb-2">Contact person with Phone & Email</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        <textarea id="add-school-info-contact" type="textarea" name="contact_phone" class="form-control form-control-solid mb-3 mb-lg-0 textarea-ck" placeholder="Contact phone & email"></textarea>
                        <!--end::Input-->
                    </div>
                    <div class="fv-row mb-7">
                        <!--begin::Label-->
                        <label for="add-school-info-sponsor" class="fw-semibold fs-6 mb-2">Sponsor Info</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        <textarea id="add-school-info-sponsor" type="textarea" name="sponsor_name" class="form-control form-control-solid mb-3 mb-lg-0 textarea-ck" placeholder="Sponsor info"></textarea>
                        <!--end::Input-->
                    </div>
                    <div class="fv-row mb-7">
                        <!--begin::Label-->
                        <label for="add-school-info-accomplish" class="fw-semibold fs-6 mb-2">Accomplishment</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        <textarea id="add-school-info-accomplish" type="textarea" name="accomplish" class="form-control form-control-solid mb-3 mb-lg-0 textarea-ck" placeholder="Your message"></textarea>
                        <!--end::Input-->
                    </div>
                    <div class="fv-row mb-7">
                        <!--begin::Label-->
                    ...
                    <div class="fv-row mb-7">
                        <!--begin::Label-->
                        <label for="add-school-info-hardware" class="fw-semibold fs-6 mb-2">Hardware Status</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        <textarea id="add-school-info-hardware" type="textarea" name="hardware" class="form-control form-control-solid mb-3 mb-lg-0 textarea-ck" placeholder="Hardware status"></textarea>
                        <!--end::Input-->
                    </div>
                    <!--begin::Input group-->
                    <div class="fv-row mb-7">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#add-news-title').on('input', function () {
                const title = $(this).val();
                const slug = generateSlug(title);
                $('#add-news-slug').val(slug);
            });
        });
    </script>
