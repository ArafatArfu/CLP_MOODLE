        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper">
            ...
            <div id="kt_app_sidebar_menu_scroll" class="scroll-y my-5 mx-3" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
                ...
                <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ request()->is('admin/schools') ? 'active' : '' }}" href="/admin/schools">
                            <span class="menu-icon">
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ request()->is('admin/school-infos') ? 'active' : '' }}" href="/admin/school-infos">
                            <span class="menu-icon">
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ request()->is('admin/centers') ? 'active' : '' }}" href="/admin/centers">
                            <span class="menu-icon">
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ request()->is('admin/subscribers') ? 'active' : '' }}" href="/admin/subscribers">
                            <span class="menu-icon">
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ request()->is('admin/volunteers') ? 'active' : '' }}" href="/admin/volunteers">
                            <span class="menu-icon">
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ request()->is('admin/donates') ? 'active' : '' }}" href="/admin/donates">
                            <span class="menu-icon">
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ request()->is('admin/contacts') ? 'active' : '' }}" href="/admin/contacts">
                            <span class="menu-icon">
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ request()->is('admin/general-update') ? 'active' : '' }}" href="/admin/general-update">
                            <span class="menu-icon">
                            ...
                            <span class="menu-title">General Update</span>
                        </a>
                        <!--end:Menu link-->
                    </div>
                    <div class="menu-item pt-5">
                        <!--begin:Menu content-->
                        <div class="menu-content">
                            <span class="menu-heading fw-bold text-uppercase fs-7">Geo Location</span>
                        </div>
                        <!--end:Menu content-->
                    </div>
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ request()->is('admin/divisions') ? 'active' : '' }}" href="/admin/divisions">
                            <span class="menu-icon">
                                <i class="fas fa-flag"></i> <!-- Font Awesome division icon -->
                            </span>
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ request()->is('admin/districts') ? 'active' : '' }}" href="/admin/districts">
                            <span class="menu-icon">
                                <i class="fas fa-map-marker"></i> <!-- Font Awesome division icon -->
                            </span>
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ request()->is('admin/upazilas') ? 'active' : '' }}" href="/admin/upazilas">
                            <span class="menu-icon">
                                <i class="fas fa-location-arrow"></i> <!-- Font Awesome division icon -->
                            </span>
                    ...
                    @hasanyrole('superadmin|admin')
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ (request()->is('admin/roles') || request()->is('admin/permissions')) ? 'show' : '' }}">
                            <!--begin:Menu link-->
                            <span class="menu-link">
                                <span class="menu-icon">
                            ...
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                ...
                                @can('view-permissions')
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link {{ request()->is('admin/permissions') ? 'active' : '' }}" href="permissions">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
