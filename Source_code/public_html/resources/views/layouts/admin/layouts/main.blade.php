...
<html lang="en">
	...
	<head><base href=""/>
		...
		<link rel="shortcut icon" href={{ asset('assets/metronic/assets/media/logos/favicon.ico') }} />
		<!--begin::Fonts(mandatory for all pages)-->
		<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Inter:300,400,500,600,700" />
		<!--end::Fonts-->
		<!--begin::Vendor Stylesheets(used for this page only)-->
		<link href={{ asset('assets/metronic/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css') }} rel="stylesheet" type="text/css" />
		<link href={{ asset('assets/metronic/assets/plugins/custom/datatables/datatables.bundle.css') }} rel="stylesheet" type="text/css" />
		<!--end::Vendor Stylesheets-->
		<!--begin::Global Stylesheets Bundle(mandatory for all pages)-->
		<link href={{ asset('assets/metronic/assets/plugins/global/plugins.bundle.css') }} rel="stylesheet" type="text/css" />
		<link href={{ asset('assets/metronic/assets/css/style.bundle.css') }} rel="stylesheet" type="text/css" />
	...
	<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
		...
		<script src={{ asset('assets/metronic/assets/plugins/global/plugins.bundle.js') }}></script>
		<script src={{ asset('assets/metronic/assets/js/scripts.bundle.js') }}></script>
		<!--end::Global Javascript Bundle-->
		<!--begin::Vendors Javascript(used for this page only)-->
		<script src={{ asset('assets/metronic/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js') }}></script>
		<!--CKEditor Build Bundles:: Only include the relevant bundles accordingly-->
		<script src={{ asset('assets/metronic/assets/plugins/custom/ckeditor/ckeditor-classic.bundle.js') }}></script>
		...
		<script src={{ asset('assets/metronic/assets/plugins/custom/datatables/datatables.bundle.js') }}></script>
