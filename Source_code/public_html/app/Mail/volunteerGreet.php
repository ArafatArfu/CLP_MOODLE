...
class volunteerGreet extends Mailable
{
    ...
    {
        //return $this->from('clpusa@clpweb.org')->subject('Thanks for staying with CLP')->view('volunteerGreet')->with('volunteer', $this->data);
        ...
        return $this->from('clpusa@clpweb.org')->subject('Thanks for staying with CLP')->html($html);
    }
}
