...
// <script> Generated 20 Aug 2025 03:41:18
(function($) {
  // Config settings
  CRM.config.userFramework = "Standalone";
    CRM.config.resourceBase = "https:\/\/clpweb.org\/core\/";
    CRM.config.packagesBase = "https:\/\/clpweb.org\/core\/packages\/";
  ...
  CRM.config.resourceCacheCode = "eJqkPen_US";
  CRM.config.quickAdd = [];
