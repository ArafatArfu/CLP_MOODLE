<?php defined('MOODLE_INTERNAL') || die();
 $configuration = array (
  ...
  array (
    ...
    'mod_quiz/quiz_overrides' => 
    array (
      'mode' => 1,
      'simplekeys' => true,
      'datasource' => 'mod_quiz\\cache\\quiz_overrides_cache',
      'component' => 'mod_quiz',
      'area' => 'quiz_overrides',
    ),
    'mod_scorm/elements' => 
    ...
    'tool_mobile/subscriptioninfo' => 
    array (
      'mode' => 1,
      'simplekeys' => true,
      'simpledata' => false,
      'component' => 'tool_mobile',
      'area' => 'subscriptioninfo',
    ),
