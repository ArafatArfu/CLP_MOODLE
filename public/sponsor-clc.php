...
//
// CLP page generated from the original CLP theme (Source_code/theme/sponsor-clc.html).
// Rendered as a self-contained page that matches the original theme exactly.

require_once(__DIR__ . '/config.php');

$PAGE->set_context(context_system::instance());
$PAGE->set_url('/sponsor-clc.php');
$PAGE->set_title('Sponsor a Computer Literacy Center (CLC)');
$PAGE->set_heading('Sponsor a Computer Literacy Center (CLC)');
echo "<!DOCTYPE html>\n<html lang=\"en\">\n";
?>
<head>
    <meta charset="UTF-8">
    <meta content="width=device-width, initial-scale=1, maximum-scale=1" name="viewport">
    <title>Sponsor a Computer Literacy Center (CLC)</title>
...
<section class="content">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12 amazonSmile-left donate">
                    <h4 class="mrg-top-remove">Sponsor a <a href="clc-teaching.php">Computer Literacy
                            Center
                            (CLC)</a> today!</h4>
                    <p class="work_para">You can sponsor a
                        <a href="clc-teaching.php">
                            ...
                            <div class="col-sm-12 col-xs-12">
                                <div class="inner clc">
                                    ...
                                    <p style="color: white" class="work_para notes">*<i>Teacher remuneration and
                                            ...
                                            the donor continues to support center maintenance by donating 0/year.</i>
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row donation-form">
                        <!--form starts here-->
                        <div class="row donation-form">
                            nsor-form', ['formAction' => route('sponsor.mail')])
                        </div>
                    </div>
                    <!--form ends here-->
                    <div class="row donation-form">
    ...
    <!--                <img src="/theme/clp/assets/images/amazonSmile-ftr-banner-img.png" alt="img" class="img-responsive">-->
    <!--            </div>                     -->
    <!--        </div>-->
    <!--    </div>-->
    <!--</section>-->
