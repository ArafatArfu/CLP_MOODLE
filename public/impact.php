...
//
// CLP page generated from the original CLP theme (Source_code/theme/impact.html).
            ...
            <div class="row">
                <div class="col-sm-7 col-xs-12">
                    ...
                    <p class="work_para">This work is made possible by donors like you who have chosen to sponsor a <a
                            href="clc-teaching.php">Computer Literacy Center (CLC)</a> or a <a
                            href="smart-classroom.php">Smart Class Room (SCR)</a>. Learn more about how you
                    ...
                    <div class="impact_sponsor_holder">
                        <div style="padding:5px;">
                            <a style="background-color: #0e0e0e; border-color: #0e0e0e;" href="sponsor-clc.php"
                               class="btn btn-primary">Sponsor a CLC</a>
                        </div>

                        <div style="padding:5px;">
                            <a style="background-color: #5f914e; border-color: #5f914e;" href="sponsor-scr.php"
                               class="btn btn-info">Sponsor a SCR</a>
                        </div>

                        <div style="padding:5px;">
                            <a style="background-color: #a1a044; border-color: #a1a044;" href="sponsor-tokai.php"
