...
//
// CLP page generated from the original CLP theme (Source_code/theme/teacher-training.html).
// Rendered as a self-contained page that matches the original theme exactly.

require_once(__DIR__ . '/config.php');

$PAGE->set_context(context_system::instance());
$PAGE->set_url('/teacher-training.php');
$PAGE->set_title('CLP | Teacher Training Program');
$PAGE->set_heading('CLP | Teacher Training Program');
echo "<!DOCTYPE html>\n<html lang=\"en\">\n";
?>
<head>
    <meta charset="UTF-8">
    <meta content="width=device-width, initial-scale=1, maximum-scale=1" name="viewport">
    <title>CLP | Teacher Training Program</title>
...
<section class="content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-xs-12">
                    <p class="work_para">Trained teachers are crucial to the success of any education and training
                        program. CLP places a high priority on training teachers and providing them with resources so
                        that they can in turn educate the students well. CLP has developed and continues to improve upon
                        training regimens for key programs, such as, Computer Literacy, Smart Class Room (SCR),
                        Education through Entertainment (EE), Connect Students around the World (CSAW) and Remote
                        Instruction. CLP has trained a total of around 1,507 teachers in these areas including over 300
                        female teachers.</p>
                </div>
                <div class="col-sm-6 col-xs-12">
                    <img src="/theme/clp/assets/images/impact/SCR.png" alt="img" class="img-responsive">
                </div>
            </div>
        </div>
    </section>

    <section style="padding-bottom: 5px;" class="impact-count-wrap">
        <div class="container">
            <div class="center extr-mrg">
                <div class="row">
                    <div class="col-sm-6 col-xs-12">
                        <p><img src="/theme/clp/assets/images/teacher-training-program/tt-1.JPG" alt="img"
                                class="img-responsive">
                        </p>
                    </div>
                    <div class="col-sm-6 col-xs-12">
                        <p class="work_para"> The first training program developed by CLP in collaboration with Dnet and
                            in consultation with leading experts in Bangladesh is focused on the Computer Fundamentals.
                            The aim is to teach teacher(s) from each Computer Literacy Center (CLC) in basic computer
                            operations and use of core Microsoft Office applications, such as, Word, Power Point, Excel,
                            Paint, etc., and browsing the Internet. </p>

                        <div class="impact-count-blk left-mrg">
                            <h4>1,507</h4>
                            <p class="work_para">teachers have been trained to teach in CLCs and SCR</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6 col-xs-12">
                        <p class="work_para">Teachers receiving this training operate the CLCs, and teach students using
                            “Esho Computer Shikhi,” a guide particularly developed for students. Around 617 teachers
                            have received this training, of which 180 are female. Facilitating the Smart Class Room
                            trains the teachers to conduct SCRs effectively. Teachers learn how to use the hardware,
                            educational CDs, and teaching contents collected from online sources. Some quick and easy
                            classroom-usable-tools are shared with them for making the class more interesting to the
                            students. Some of the sessions discuss how to develop contents using the MS PowerPoint,
                            video editing applications, and downloading from the Internet. Including 300 female
                            teachers, 807 teachers received this training.</p>
                    </div>
                    <div class="col-sm-6 col-xs-12">
                        <img src="/theme/clp/assets/images/teacher-training-program/tt-2.webp" alt="img"
    ...
    <div class="section-title center">
        <h2>Teacher Training during the <span class="thm-color">COVID-19 Pandemic</span></h2>
    </div>

    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-xs-12">
                <p class="work_para">CLP’s implementation partner Dnet started an online training program on various
                    topics with 107 teachers from 72 different institutions across the country after the first COVID-19
                    lockdown was relaxed. The topics covered in this training included the Computer Fundamentals,
                    Digital Pedagogy, Facilitating the Smart Class Room and Developing Contents for SCR described
                    above.</p>
            </div>
            <div class="col-sm-6 col-xs-12">
                <img src="/theme/clp/assets/images/teacher-training-program/tt-3.png" alt="img"
                     class="img-responsive">
            </div>
        </div>
    ...
    <div class="section-title center extr-mrg">
        <h2>Teacher Training for <span class="thm-color">Remote Teachers</span></h2>
    </div>

    <section style="padding-bottom: 10px;" class="impact-count-wrap">
        <div class="container">
            <div class="center extr-mrg-2">
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        <p class="work_para">During COVID-19 Pandemic, CLP has provided online training on various
                            topics to 33 teachers from five different institutions across the country. The institutions
                            are Ati Panchdona High School, Krishnapur Govt. Primary School, Upazila Sadar Model Govt.
                            Primary School, Sherpur Town Colony AJ High School, and Alhaj Amzad Hossain Degree College.
                            Some of the main training topics were -

                            As per feedback from the participants, the training helped them immensely to improve the
                            respective topics and they were quite hopeful to be utilizing the acquired knowledge in the
                            classrooms. The next on the agenda is conducting a refreshers’ training for the project
                            teachers of CLP’s 81 supported schools. All the aforementioned training segments will be
                            included in the refreshers’ training also.</p>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-xs-12">
                            ...
                            <ul class="list-group work_para">
                                <li class="list-group-item">a. <strong>Computer Fundamentals Training:</strong> Computer
                                    Fundamental Training aims to train the teachers about basic computer operations as
                                    well as using some of the core Microsoft Office applications, such as, MS Word, MS
                                    PowerPoint, MS Excel, MS Paint, etc.
                                </li>
                                <li class="list-group-item">b. <strong>Digital Pedagogy Training:</strong> The aim was
                                    to develop the teachers’ expertise in conducting effective online multimedia classes
                                    using digital technology and appropriate pedagogical knowledge. After receiving the
                                    training, they got to know how digital pedagogy can be used best and how much impact
                                    it can create on students’ learning capability and willingness.
                                </li>
                                <li class="list-group-item">c. <strong>Facilitating the SCR:</strong> The teachers were
                                    trained to conduct Smart Classrooms (SCRs) effectively. In this part of the
                                    training, some quick and easy classroom-usable-tools have been shared with them for
                                    making the class more interesting to the students.
                                </li>
                                <li class="list-group-item">d. <strong>Developing Contents for SCR:</strong> There were
                                    some sessions on developing content to use in the classrooms. In this part of the
                                    training, teachers were taught how to create content not only by using the MS
                                    PowerPoint but also to generate video contents using simple video editing
                                    applications.
                                </li>
                                <li class="list-group-item">e. <strong>Training of Teachers:</strong> The assigned CLC
                                    teachers received training which instructed them on the purpose and process of
                                    conducting the students’ computer training using the “let’s cheer, do, and share”
                                    methodology.
                                </li>
                            </ul>
                            </p>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 col-xs-12">
                            <p class="work_para">
                                As per feedback from the participants, the training helped them immensely to improve the
                                respective topics and they were quite hopeful to be utilizing the acquired knowledge in
                                the classrooms. The next on the agenda is conducting a refreshers’ training for the
                                project teachers of CLP’s 81 supported schools. All the aforementioned training segments
                                will be included in the refreshers’ training also.</p>
                        </div>
                    </div>
                </div>
            </div>
