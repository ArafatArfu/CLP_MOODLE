(function($) {
    ...
    // Initialize the mega menu once the DOM is ready and after each load
    // (the theme loads its scripts in <head>, so the element may not exist yet).
    if (document.readyState === "loading") {
        $(document).ready(initMainMenu);
    } else {
        initMainMenu();
    }
    $(window).on("load", initMainMenu);
