...
//
// CLP page generated from the original CLP theme (Source_code/theme/sherpurpr.html).
// Rendered as a self-contained page that matches the original theme exactly.

require_once(__DIR__ . '/config.php');

$PAGE->set_context(context_system::instance());
$PAGE->set_url('/sherpurpr.php');
...
<head>
    ...
    <title>Sherpur &amp; Dhunat Project</title>
    ...
    <div id="carousel" class="carousel slide" data-ride="carousel" style="border: 10px solid #e0e0e345;">
        ...
        <div class="carousel-inner">
            <div class="active item">
                <img class="img-responsive" src="/theme/clp/assets/images/homepage/Sherpur/molla-sir-min.jpg" />
                <div class="carousel-caption">
                </div>
            </div>
            <div class="item">
                <img class="img-responsive" src="/theme/clp/assets/images/homepage/Sherpur/1.jpeg" />
                <div class="carousel-caption">
            ...
            <div class="item">
                <img class="img-responsive" src="/theme/clp/assets/images/homepage/Sherpur/s-1.jpg">
                <div class="carousel-caption">
                    <div class="carouselBtn">
                    </div>
                </div>
            ...
            <div class="item">
                <img class="img-responsive" src="/theme/clp/assets/images/homepage/Sherpur/3.jpeg">
                <div class="carousel-caption">
                    <div class="carouselBtn">
                    </div>
                </div>
...
Our goal is 0,000 to provide technology, connectivity, and mentorship for this cohort and to seed the revolving fund. By February 2026, we expect the first cohort to reach financial stability and help launch the next group of Sherpur freelancers.
                ...
                <div class="sidebar-area">
                    <div class="widget widget-letest-news">
                        ...
                        <div class="news-list">
                            ...
                            <a class="read-more" href="latest-news.php">View All</a>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="introduction-wrap fact-counter-2 sec-padd"
    style="background-image: url(/theme/clp/assets/images/bg.webp);">
