...
//
// CLP page generated from the original CLP theme (Source_code/theme/teacher-training-program.html).
// Rendered as a self-contained page that matches the original theme exactly.

require_once(__DIR__ . '/config.php');
require_once(__DIR__ . '/ourwork-helper.php');
$ourwork_slug = 'teacher-training';
...
$PAGE->set_url('/teacher-training-program.php');
