...
//
// CLP page generated from the original CLP theme (Source_code/theme/contact-us.html).
// Rendered as a self-contained page that matches the original theme exactly.

require_once(__DIR__ . '/config.php');

$PAGE->set_context(context_system::instance());
$PAGE->set_url('/contact-us.php');
$PAGE->set_title('CLP | Contact Us');
$PAGE->set_heading('CLP | Contact Us');
echo "<!DOCTYPE html>\n<html lang=\"en\">\n";
?>
<head>
    <meta charset="UTF-8">
    <meta content="width=device-width, initial-scale=1, maximum-scale=1" name="viewport">
    <title>CLP | Contact Us</title>
            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    <p style="font-size: 14px;" class="work_para">Our dedicated teams in the USA, Canada, and Bangladesh
                        ...
                        officer or member of our team, <a href="team.php"><strong>please visit the team
                                page</strong></a>.</p>

                    <p style="font-size: 14px;" class="work_para">Looking for the volunteer form? <a
                            href="volunteer.php"><strong>Submit your contact details</strong></a> and
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-5 col-xs-12">
                    <img src="/theme/clp/assets/images/contact-us-img.png" alt="img" class="img-responsive"/>
                </div>
            </div>
        </div>
    </section>
