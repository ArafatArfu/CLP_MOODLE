...
//
// CLP page generated from the original CLP theme (Source_code/theme/annual-report.html).
// Rendered as a self-contained page that matches the original theme exactly.

require_once(__DIR__ . '/config.php');

$PAGE->set_context(context_system::instance());
$PAGE->set_url('/annual-report.php');
$PAGE->set_title('CLP | Annual Status Report');
$PAGE->set_heading('CLP | Annual Status Report');
echo "<!DOCTYPE html>\n<html lang=\"en\">\n";
?>
<head>
    <meta charset="UTF-8">
    <meta content="width=device-width, initial-scale=1, maximum-scale=1" name="viewport">
    <title>CLP | Annual Status Report</title>
...
<section class="content">
    ...
    <section class="cards-wrapper">
        <div class="card-grid-space">
            <a class="card-magazine" target="_blank" href="/theme/clp/assets/fileupload/annual-report/2021-Year-End-Report.pdf"
               style="--bg-img: url(/theme/clp/assets/images/annual_report/2021.png)">
        ...
        <div class="card-grid-space">
            <a class="card-magazine" target="_blank" href="/theme/clp/assets/fileupload/annual-report/2020-Year-End-Report.pdf"
               style="--bg-img: url(/theme/clp/assets/images/annual_report/2020.png)">
                <div class="ribbon-wrapper">
        ...
        <div class="card-grid-space">
            <a class="card-magazine" target="_blank" href="/theme/clp/assets/fileupload/annual-report/2019-Year-End-Report.pdf"
               style="--bg-img: url(/theme/clp/assets/images/annual_report/2019.png)">
                <div class="ribbon-wrapper">
        ...
        <div class="card-grid-space">
            <a class="card-magazine" target="_blank" data-label="2019" href="/theme/clp/assets/fileupload/annual-report/2018-Year-End-Report.pdf"
               style="--bg-img: url(/theme/clp/assets/images/annual_report/2018.png)">
                <div>
                    <div class="ribbon-wrapper">
        ...
        <div class="card-grid-space">
            <a class="card-magazine" target="_blank" data-label="2017" href="/theme/clp/assets/fileupload/annual-report/2014_Year_End-Report.pdf"
               style="--bg-img: url(/theme/clp/assets/images/annual_report/2014.png)">
                <div>
                    <div class="ribbon-wrapper">
        ...
        <div class="card-grid-space">
            <a class="card-magazine" target="_blank" data-label="2016" href="/theme/clp/assets/fileupload/annual-report/Annual_Report_2013.pdf"
               style="--bg-img: url(/theme/clp/assets/images/annual_report/2013.png)">
                <div>
                    <div class="ribbon-wrapper">
        ...
        <div class="card-grid-space">
            <a class="card-magazine" target="_blank" data-label="2015" href="/theme/clp/assets/fileupload/annual-report/Annual-Report-2012.pdf"
               style="--bg-img: url(/theme/clp/assets/images/annual_report/2012.png)">
                <div>
                    <div class="ribbon-wrapper">
        ...
        <div class="card-grid-space">
            <a class="card-magazine" target="_blank" data-label="2014" href="/theme/clp/assets/fileupload/annual-report/Annual-Report-2011.pdf"
               style="--bg-img: url(/theme/clp/assets/images/annual_report/2011.png)">
                <div>
                    <div class="ribbon-wrapper">
        ...
        <div class="card-grid-space">
            <a class="card-magazine" target="_blank" data-label="2013" href="/theme/clp/assets/fileupload/annual-report/Annual-Report-2010.pdf"
               style="--bg-img: url(/theme/clp/assets/images/annual_report/2010.png)">
                <div>
                    <div class="ribbon-wrapper">
        ...
        <div class="card-grid-space">
            <a class="card-magazine" target="_blank" data-label="2012" href="/theme/clp/assets/fileupload/annual-report/clp_status_2008.pdf"
               style="--bg-img: url(/theme/clp/assets/images/annual_report/2008.png)">
                <div>
                    <div class="ribbon-wrapper">
        ...
        <div class="card-grid-space">
            <a class="card-magazine" target="_blank" data-label="2011" href="/theme/clp/assets/fileupload/annual-report/clp_status_2007.pdf"
               style="--bg-img: url(/theme/clp/assets/images/annual_report/2007.png)">
                <div>
                    <div class="ribbon-wrapper">
        ...
        <div class="card-grid-space">
            <a class="card-magazine" target="_blank" data-label="2010" href="/theme/clp/assets/fileupload/annual-report/clp_status_2006.pdf"
               style="--bg-img: url(/theme/clp/assets/images/annual_report/2006.png)">
                <div>
                    <div class="ribbon-wrapper">
