...
//
// CLP page generated from the original CLP theme (Source_code/theme/connect-students.html).
// Rendered as a self-contained page that matches the original theme exactly.

require_once(__DIR__ . '/config.php');

$PAGE->set_context(context_system::instance());
$PAGE->set_url('/connect-students.php');
$PAGE->set_title('CLP | Connecting Students Around the World');
$PAGE->set_heading('CLP | Connecting Students Around the World');
echo "<!DOCTYPE html>\n<html lang=\"en\">\n";
?>
<head>
    <meta charset="UTF-8">
    <meta content="width=device-width, initial-scale=1, maximum-scale=1" name="viewport">
    <title>CLP | Connecting Students Around the World</title>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4 col-xs-12 col-sm-offset-1">
                    <p class="connect-img"><img src="/theme/clp/assets/images/connect-students/students1.png"
                                                alt="img" class="img-responsive"/></p>
                    <p class="work_para">WAMS participants during Skype conversation with UBSBN participants.</p>
                    <p class="connect-img"><img src="/theme/clp/assets/images/connect-students/Pic2.jpg"
                                                alt="img" class="img-responsive"/></p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-5 col-xs-12">
                    <p class="connect-img"><img src="/theme/clp/assets/images/connect-students/students.png"
                                                alt="img" class="img-responsive"/></p>
                    <p class="work_para">UBSBN participants speaking with WAMS participants via Skype video call.</p>
                </div>
            </div>
            ...
            <div class="row extr-mrg-top">
                <div class="col-sm-5 col-xs-12">
                    <p class="connect-img"><img src="/theme/clp/assets/images/connect-students/blog-img4.png"
                                                alt="img" class="img-responsive"/></p>
                    <p class="work_para">WAMS participants during Skype conversation with UBSBN participants.</p>
                </div>
                <div class="col-sm-7 col-xs-12">
