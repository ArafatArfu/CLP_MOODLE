...
//
// CLP page generated from the original CLP theme (Source_code/theme/curriculum-development.html).
// Rendered as a self-contained page that matches the original theme exactly.

require_once(__DIR__ . '/config.php');

$PAGE->set_context(context_system::instance());
$PAGE->set_url('/curriculum-development.php');
$PAGE->set_title('CLP | Curriculum Development');
$PAGE->set_heading('CLP | Curriculum Development');
echo "<!DOCTYPE html>\n<html lang=\"en\">\n";
?>
<head>
    <meta charset="UTF-8">
    <meta content="width=device-width, initial-scale=1, maximum-scale=1" name="viewport">
    <title>CLP | Curriculum Development</title>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-4 col-xs-12 col-sm-offset-1">
                    <p class="connect-img">
                        <img src="/theme/clp/assets/images/curriculum-development/book.png" alt="img"
