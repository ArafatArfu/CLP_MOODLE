...
//
// CLP page generated from the original CLP theme (Source_code/theme/donation-mail.html).
// Rendered as a self-contained page that matches the original theme exactly.

require_once(__DIR__ . '/config.php');

$PAGE->set_context(context_system::instance());
$PAGE->set_url('/donation-mail.php');
$PAGE->set_title('CLP | Donate By Mail');
$PAGE->set_heading('CLP | Donate By Mail');
echo "<!DOCTYPE html>\n<html lang=\"en\">\n";
?>
<head>
    <meta charset="UTF-8">
    <meta content="width=device-width, initial-scale=1, maximum-scale=1" name="viewport">
    <title>CLP | Donate By Mail</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-xs-12 amazonSmile-left">
                    ...
                    <div class="amazonSmile-right">
    <h4>Thank you for supporting our work to bring computer literacy to rural Bangladesh.</h4>
    <p class="work_para">Tax ID 46-0646134</p>
    <p class="work_para">Please contact us at (732) 972-8362 or email clp@clpweb.org with any
        questions.</p>
    <h4>There are several ways you can support CLP. Check out these links to learn more.</h4>
    <p><a href="sponsor-clc.php">SPONSOR A CLC</a></p>
    <p><a href="sponsor-scr.php">SPONSOR A SCR</a></p>
    <p><a href="sponsor-computer.php">SPONSOR A COMPUTER</a></p>
    <p><a href="donation-online.php">DONATE ONLINE</a></p>
    <p><a href="donation-mail.php">DONATE BY MAIL</a></p>
    <p><a href="donation-amazon.php">DONATE BY AMAZONSMILE</a></p>
    <p><a href="volunteer.php">BE A VOLUNTEER</a></p>
</div>
