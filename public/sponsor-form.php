...
//
// CLP page generated from the original CLP theme (Source_code/theme/sponsor-form.html).
// Rendered as a self-contained page that matches the original theme exactly.

require_once(__DIR__ . '/config.php');

$PAGE->set_context(context_system::instance());
$PAGE->set_url('/sponsor-form.php');
$PAGE->set_title('Donation');
$PAGE->set_heading('Donation');
echo "<!DOCTYPE html>\n<html lang=\"en\">\n";
?>
<head>
    <meta charset="UTF-8">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12 d-flex flex-column align-items-center text-center">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input @error('payment_method') is-invalid @enderror" type="radio" id="paypal" name="payment_method" value="Paypal"  required>
                                    <label class="form-check-label" for="paypal">Paypal</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input @error('payment_method') is-invalid @enderror" type="radio" id="cheque" name="payment_method" value="Cheque"  required>
                                    <label class="form-check-label" for="cheque">Cheque</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input @error('zelle_method') is-invalid @enderror" type="radio" id="zelle" name="payment_method" value="Zelle"  required>
                                    <label class="form-check-label" for="zelle">ZellePay | Using: CLP | vabnj@hotmail.com</label>
                                </div>
                                @error('payment_method')
                                    <div class="invalid-feedback d-block" style="color: red;"></div>
                                @enderror
