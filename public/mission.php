...
//
// CLP page generated from the original CLP theme (Source_code/theme/mission.html).
...
<section class="content">
    ...
    <section class="introduction-wrap fact-counter-2 sec-padd" style="background-image: url(/theme/clp/assets/images/introduction-bg.png);">
