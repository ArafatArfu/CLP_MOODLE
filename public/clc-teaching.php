...
$PAGE->set_title('Computer Literacy Center (CLC)');
$PAGE->set_heading('Computer Literacy Center (CLC)');
echo "<!DOCTYPE html>\n<html lang=\"en\">\n";
?>
<head>
    <meta charset="UTF-8">
    <meta content="width=device-width, initial-scale=1, maximum-scale=1" name="viewport">
    <title>Computer Literacy Center (CLC)</title>
...
<section class="content">
                    ...
                    <div style="border: 10px solid #e0e0e345;" id="carousel" class="carousel slide"
                        ...
                        <div class="carousel-inner carousel-zoom">
                            <div class="active item slider-inner-img"><img class="img-responsive"
                                                                           src="/theme/clp/assets/images/slider/clc_slider/clc_slider_1.webp">
                            </div>

                            <div class="item slider-inner-img"><img class="img-responsive"
                                                                    src="/theme/clp/assets/images/slider/clc_slider/clc_slider_5.jpg">
                            </div>

                            <div class="item slider-inner-img"><img class="img-responsive"
                                                                    src="/theme/clp/assets/images/slider/clc_slider/clc_slider_2.webp">
                            </div>

                            <div class="item slider-inner-img"><img class="img-responsive"
                                                                    src="/theme/clp/assets/images/slider/clc_slider/clc_slider_3.webp">
                            </div>

                            <div class="item slider-inner-img"><img class="img-responsive"
                                                                    src="/theme/clp/assets/images/slider/clc_slider/clc_slider_4.webp">
                            </div>
    ...
    <section class="sponsorship-wrap ">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <p><img src="/theme/clp/assets/images/clc/esho.jpg" alt="img" class="img-responsive"/></p>
                </div>
                
                <div class="col-xs-12">
                    <p><img src="/theme/clp/assets/images/clc/clc-certificate.jpg" alt="img" class="img-responsive"/></p>
                </div>
    ...
    <section class="history-wrap ">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-7 col-xs-12">
                    <p class="work_para">Starting in 2005, CLP has established  CLCs (and 97
                        associate
                        CLCs) in  districts of Bangladesh; have produced around  digital literacy graduates, ~
                        
                        of those being females, and trained  teachers. Annually 100,000 students use the digital
                ...
                <div class="col-sm-5 col-xs-12">
                    <p><img src="/theme/clp/assets/uploads/school_image/map.jpg" alt="img"
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-xs-12">
                    ...
                    <p class="btn-area donate-now text-left">
                        <a href="sponsor-clc.php" class="thm-btn">Sponsor a CLC</a>
                    </p>
                ...
                <div class="col-sm-6 col-xs-12">
                    <p><img src="/theme/clp/assets/images/clc/barishal-plaque.jpg" alt="img" class="img-responsive">
                    </p>
