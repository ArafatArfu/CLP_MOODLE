...
//
// CLP page generated from the original CLP theme (Source_code/theme/training-material.html).
...
$PAGE->set_title('DEVELOP TRAINING MATERIALS AND CONTENTS');
$PAGE->set_heading('DEVELOP TRAINING MATERIALS AND CONTENTS');
echo "<!DOCTYPE html>\n<html lang=\"en\">\n";
?>
<head>
    <meta charset="UTF-8">
