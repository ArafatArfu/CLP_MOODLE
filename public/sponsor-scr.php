...
//
// CLP page generated from the original CLP theme (Source_code/theme/sponsor-scr.html).
// Rendered as a self-contained page that matches the original theme exactly.

require_once(__DIR__ . '/config.php');

$PAGE->set_context(context_system::instance());
$PAGE->set_url('/sponsor-scr.php');
$PAGE->set_title('Sponsor a Smart Classroom (SCR)');
$PAGE->set_heading('Sponsor a Smart Classroom (SCR)');
echo "<!DOCTYPE html>\n<html lang=\"en\">\n";
?>
<head>
    <meta charset="UTF-8">
    <meta content="width=device-width, initial-scale=1, maximum-scale=1" name="viewport">
    <title>Sponsor a Smart Classroom (SCR)</title>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12 amazonSmile-left donate">
                    <h4 class="mrg-top-remove">Sponsor a <a href="smart-classroom.php">Smart Class
                            Room
                            (SCR)</a> today!</h4>
                    <p class="work_para">You can sponsor a <a href="smart-classroom.php"><u>Smart
                                Class Room
