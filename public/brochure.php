...
//
// CLP page generated from the original CLP theme (Source_code/theme/brochure.html).
// Rendered as a self-contained page that matches the original theme exactly.

require_once(__DIR__ . '/config.php');

$PAGE->set_context(context_system::instance());
$PAGE->set_url('/brochure.php');
$PAGE->set_title('CLP | Brochure');
$PAGE->set_heading('CLP | Brochure');
echo "<!DOCTYPE html>\n<html lang=\"en\">\n";
?>
<head>
    <meta charset="UTF-8">
    <meta content="width=device-width, initial-scale=1, maximum-scale=1" name="viewport">
    <title>CLP | Brochure</title>
            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    <p class="brochure-img">
                        <a href="/theme/clp/assets/images/clpb3.png" download="">
                            <img src="/theme/clp/assets/images/clpb3.jpg" alt="img"
                                 class="img-responsive"></a></p>
                    <p class="brochure-img">
                        <a href="/theme/clp/assets/images/clpb2.jpg" download=""><img
                                src="/theme/clp/assets/images/clpb2.jpg" alt="img"
                                class="img-responsive"></a></p>
                </div>
            </div>
        </div>
