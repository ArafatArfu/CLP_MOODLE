...
//
// CLP page generated from the original CLP theme (Source_code/theme/dhunat-project.html).
// Rendered as a self-contained page that matches the original theme exactly.

require_once(__DIR__ . '/config.php');

$PAGE->set_context(context_system::instance());
$PAGE->set_url('/dhunat-project.php');
$PAGE->set_title('Dhunat Project');
$PAGE->set_heading('Dhunat Project');
echo "<!DOCTYPE html>\n<html lang=\"en\">\n";
?>
<head>
    <meta charset="UTF-8">
    <meta content="width=device-width, initial-scale=1, maximum-scale=1" name="viewport">
    <title>Dhunat Project</title>
        ...
        <div id="carousel" class="carousel slide" data-ride="carousel" style="border: 10px solid #e0e0e345;">
            ...
            <div class="carousel-inner">
                <div class="active item">
                    <img class="img-responsive" src="/theme/clp/assets/images/homepage/Dhunat/image1.jpg"/>
                </div>
                <div class="item">
                    <img class="img-responsive" src="/theme/clp/assets/images/homepage/Dhunat/image2.jpg"/>
                </div>
                <div class="item">
                    <img class="img-responsive" src="/theme/clp/assets/images/homepage/Dhunat/image3.jpg">
                </div>
            </div>
