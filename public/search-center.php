...
//
// CLP page generated from the original CLP theme (Source_code/theme/search-center.html).
// Rendered as a self-contained page that matches the original theme exactly.

require_once(__DIR__ . '/config.php');

$PAGE->set_context(context_system::instance());
$PAGE->set_url('/search-center.php');
$PAGE->set_title('CLP | Search Center');
$PAGE->set_heading('CLP | Search Center');
echo "<!DOCTYPE html>\n<html lang=\"en\">\n";
?>
<head>
    <meta charset="UTF-8">
    <meta content="width=device-width, initial-scale=1, maximum-scale=1" name="viewport">
    <title>CLP | Search Center</title>
            ...
            <div class="col-md-6">
                <div style="margin: 0 auto; max-width: 100%;" class="panel panel-success">
                    ...
                    <div class="panel-body">
                        <form method="GET" action="school-details.html">
