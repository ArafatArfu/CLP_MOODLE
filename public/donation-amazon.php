...
//
// CLP page generated from the original CLP theme (Source_code/theme/donation-amazon.html).
// Rendered as a self-contained page that matches the original theme exactly.

require_once(__DIR__ . '/config.php');

$PAGE->set_context(context_system::instance());
$PAGE->set_url('/donation-amazon.php');
$PAGE->set_title('CLP | Help CLP Through AmazonSmile');
$PAGE->set_heading('CLP | Help CLP Through AmazonSmile');
echo "<!DOCTYPE html>\n<html lang=\"en\">\n";
?>
<head>
    <meta charset="UTF-8">
    <meta content="width=device-width, initial-scale=1, maximum-scale=1" name="viewport">
    <title>CLP | Help CLP Through AmazonSmile</title>
...
<section class="content">
    ...
    margin: 0 auto;" src="/theme/clp/assets/images/amazonsmile/smile_1.png" alt="img" class="img-responsive"/>
                    ...
                    <ul class="list-group work_para">
                        ...
                        <li class="list-group-item">After successful registration a window (please see the image below)
                            ...
                            Shopping" button.<img src="/theme/clp/assets/images/amazonsmile/smile_2.png"
                                                  alt="img"
