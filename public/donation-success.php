...
//
// CLP page generated from the original CLP theme (Source_code/theme/donation-success.html).
// Rendered as a self-contained page that matches the original theme exactly.

require_once(__DIR__ . '/config.php');

$PAGE->set_context(context_system::instance());
$PAGE->set_url('/donation-success.php');
$PAGE->set_title('Donation Success');
$PAGE->set_heading('Donation Success');
echo "<!DOCTYPE html>\n<html lang=\"en\">\n";
?>
<head>
    <meta charset="UTF-8">
