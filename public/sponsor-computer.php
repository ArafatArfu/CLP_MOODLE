...
//
// CLP page generated from the original CLP theme (Source_code/theme/sponsor-computer.html).
// Rendered as a self-contained page that matches the original theme exactly.

require_once(__DIR__ . '/config.php');

$PAGE->set_context(context_system::instance());
$PAGE->set_url('/sponsor-computer.php');
$PAGE->set_title('CLP | Sponsor a Computer');
$PAGE->set_heading('CLP | Sponsor a Computer');
echo "<!DOCTYPE html>\n<html lang=\"en\">\n";
?>
<head>
    <meta charset="UTF-8">
    <meta content="width=device-width, initial-scale=1, maximum-scale=1" name="viewport">
    <title>CLP | Sponsor a Computer</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-xs-12 amazonSmile-left donate">
                    ...
                    <p class="work_para">With your 0 donation, one laptop with core i3 specifications will be
                        provided to a <a href="clc-teaching.php">Computer Literacy Center (CLC)</a> on your
