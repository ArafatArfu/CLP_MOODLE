...
//
// CLP page generated from the original CLP theme (Source_code/theme/five-dollar-graduate.html).
// Rendered as a self-contained page that matches the original theme exactly.

require_once(__DIR__ . '/config.php');

$PAGE->set_context(context_system::instance());
$PAGE->set_url('/five-dollar-graduate.php');
$PAGE->set_title('$5 CLP Graduate');
$PAGE->set_heading('$5 CLP Graduate');
echo "<!DOCTYPE html>\n<html lang=\"en\">\n";
?>
<head>
    <meta charset="UTF-8">
    <meta content="width=device-width, initial-scale=1, maximum-scale=1" name="viewport">
    <title>$5 CLP Graduate</title>
...
<section class="content">
    ...
    <section class="education-through-wrap sec-padd">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-xs-12">
                    <img src="/theme/clp/assets/images/5_graduate/5_graduate1.png" alt="img"
                         class="img-responsive"/>
                </div>
                <div class="col-sm-6 col-xs-12">
                    <p class="work_para">CLP costs for this project include teacher honorarium (~ 0 per year per
                        school), Dnet supervision supports as well as miscellaneous support items (` 0 per year per
                        school). So, CLP will be able to produce digital literates at a very nominal cost from the
                        non-clp schools (0 per school per year). It will cost 0 per graduate if each school is
