...
//
// CLP page generated from the original CLP theme (Source_code/theme/formative-reports.html).
// Rendered as a self-contained page that matches the original theme exactly.

require_once(__DIR__ . '/config.php');

$PAGE->set_context(context_system::instance());
$PAGE->set_url('/formative-reports.php');
$PAGE->set_title('CLP | Formative Reports');
$PAGE->set_heading('CLP | Formative Reports');
echo "<!DOCTYPE html>\n<html lang=\"en\">\n";
?>
<head>
    <meta charset="UTF-8">
    <meta content="width=device-width, initial-scale=1, maximum-scale=1" name="viewport">
    <title>CLP | Formative Reports</title>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-5 col-xs-12">
                    <img src="/theme/clp/assets/images/formative-report-img.png" alt="img" class="img-responsive">
                </div>
